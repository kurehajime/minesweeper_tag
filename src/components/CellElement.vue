...
<template>
    <g>
        ...
        <text :x="props.x + cellSize / 2" :y="props.y + cellSize / 2" textAnchor="middle" dominantBaseline="central"
        ...
        <g :display="props.cell.Open ? 'none' : 'block'">
            ...
            <line :x1="props.x + 0" :y1="props.y + 0" :x2="props.x + cellSize" :y2="props.y + 0"
                :stroke="props.selected ? 'blue' : 'white'" strokeWidth="3" />
            <line :x1="props.x + cellSize - 3" :y1="props.y + 0" :x2="props.x + cellSize - 3" :y2="props.y + cellSize"
                :stroke="props.selected ? 'blue' : 'gray'" strokeWidth=" 3" />
            <line :x1="props.x + cellSize - 3" :y1="props.y + cellSize - 3" :x2="props.x + 0"
                :y2="props.y + cellSize - 3" :stroke="props.selected ? 'blue' : 'gray'" strokeWidth="3" />
